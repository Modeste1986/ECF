                        ...
                        <tbody>
                            @foreach ($category as $key => $cat)
                             <tr>
                                 ...
                                 <th>
                                     <a href="{{ url('admin/edit_category/'.$cat['id'])}}" class="btn btn-info">Editer</a>
                                     <a href="{{ url('admin/delete_category/'.$cat['id'])}}" class="btn btn-danger">Effacer</a>
                                 </th>
                             </tr>   
                            @endforeach
                        </tbody>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Ajouter nouvelle categorie</h4>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label for="">Entrer nom categorie </label>
                            {{ csrf_field()}}
